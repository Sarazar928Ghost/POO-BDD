...
class Main
{
    public function start()
    {
        ...
        if($params && $params[0] != '')
        {
            ...
            // On instancie le contrôleur , si il n'éxiste pas on met le Main par défaut
            $controller = (class_exists($controller)) ? new $controller() : new MainController;
        ...
        }else
        {
            ...
            // On appelle index du MainController
            $controller->index();
        }
